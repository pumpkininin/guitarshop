...
<body>
    ...
    <div class="containter-fluid">
        ...
        <div class="filter">
            <form action="index.php?controller=productController&action=filter" method="POST" style="width:35%; margin:auto; margin-bottom:50px">
    ...
    <div class="icon-bar">
        <div class="chat-icon">
            <img src="./images/chat-icon.png" onClick="" style="width:75px;">
        </div>
    </div>
